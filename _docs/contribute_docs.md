...
<img class="img-responsive" src="../../img/git_pull_request.png" alt="how to make a pull request to the original GOAT-website repository" title="Make a pull request"/>
